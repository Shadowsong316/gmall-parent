...
public class PmsProductAttributeController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "type", value = "0表示销售属性，1表示普通参数", required = true, paramType = "query")})
    ...
    public Object getList(@PathVariable Long cid,
        ...
        // 根据分类查询属性列表或参数列表
        Map<String,Object> map=productAttributeService.pageProductAttribute(cid,type,pageSize,pageNum);
    ...
    public Object create(@RequestBody PmsProductAttributeParam productAttributeParam, BindingResult bindingResult) {
        ...
        return new CommonResult().success("添加商品属性信息完成");
    }
    ...
    public Object update(@PathVariable Long id, @RequestBody PmsProductAttributeParam productAttributeParam, BindingResult bindingResult){
        ...
        return new CommonResult().success("修改商品属性信息完成");
    }
    ...
    public Object delete(@RequestParam("ids") List<Long> ids){
        ...
        return new CommonResult().success("批量删除商品属性完成");
    }

    @ApiOperation("根据商品分类的id获取商品属性及属性分类")
    @GetMapping(value = "/attrInfo/{productCategoryId}")
    public Object getAttrInfo(@PathVariable Long productCategoryId){
        //TODO 根据分类查询属性列表或参数列表 没看懂用处  暂时先不做
//        List<> list=productAttributeService.attrInfoByProductCategoryId(productCategoryId);
